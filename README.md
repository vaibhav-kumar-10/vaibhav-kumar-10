...
I'm a **Computer Science & Engineering senior** with hands-on experience building optimized, production-ready software systems across **machine learning, computer vision, robotics, and full-stack development**. I have a strong foundation in CS fundamentals and a proven ability to design, implement, and optimize end-to-end systems that operate under real-world constraints.

Recently I delivered a **2000% performance improvement** on an industry-sponsored rail inspection system by redesigning compute-intensive workflows using **multithreading, asynchronous processing, CUDA optimization, and efficient memory management**. I've also developed and trained transformer-based computer vision models, integrated machine learning into user-facing applications, and deployed scalable backend services in cloud environments including **AWS and Google Cloud**.

Beyond applied ML, I've built full-stack applications using modern web technologies, implemented secure authentication and authorization, and managed production-scale Java codebases with a focus on **modular architecture, scalability, and maintainability**.

🎯 I'm currently seeking **entry-level software engineering, machine learning, computer vision, robotics, or full-stack roles** where I can continue learning, contribute to impactful projects, and grow as an engineer.
...
A fully functional chess application built in Java with a Swing-based GUI. Supports algebraic notation input, legal move validation, full move history tracking, and animated graphics.
...
| Plugin | Description |
|---|---|
| [**core-api**](https://github.com/Battlegrounds-Development/core-api) | Public integration API — global services, player data & cross-module communication |
| [**adventure**](https://github.com/Battlegrounds-Development/adventure) | Extraction engine: map rotations, world bosses, loot tables & match flow |
| [**bunker**](https://github.com/Battlegrounds-Development/bunker) | Private player instances with upgrades, purchasing & persistence |
| [**armor**](https://github.com/Battlegrounds-Development/armor) | Custom attribute-based armor sets for tactical PvP |
| [**items**](https://github.com/Battlegrounds-Development/items) | Tactical items framework: Molotovs, Grenades, Tear Gas & more |
| [**reputation**](https://github.com/Battlegrounds-Development/reputation) | Dynamic dealer system tracking transactions & scaling NPC permissions |
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=vaibhav-kumar-10&show_icons=true&theme=tokyonight&hide_border=true" alt="Vaibhav's GitHub stats" width="48%" />
...
I'm always open to chatting about engineering, open-source, or new opportunities. Feel free to reach out!
